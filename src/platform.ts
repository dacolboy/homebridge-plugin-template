...
import { YamahaAccessory } from './yamahaAccessory.js';
...
export class HomebridgePlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    for (const device of this.config.accessories) {
      ...
      //const devAccessories: PlatformAccessory[] = [];
      ...
      if (existingAccessory) {
        ...
        // this is imported from `platformAccessory.ts`
        const yamahaAccessory = new YamahaAccessory(this, accessory);

        // link the accessory to your platform
        //this.api.registerPlatformAccessories(PLUGIN_NAME, PLATFORM_NAME, [accessory]);
        //this.api.publishExternalAccessories(PLUGIN_NAME, [accessory]);
        yamahaAccessory.publishAccessory(PLUGIN_NAME);
      }
  ...
  instantiateAccessory(accessory: PlatformAccessory) {
    switch (accessory.context.device.tipo) {
    case 'yamaha':
      new YamahaAccessory(this, accessory);
      break;
    case 'yamahavolume':
    //  new YamahaVolumeAccessory(this, accessory);
    }
  }
}
